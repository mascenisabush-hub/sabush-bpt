...
| 19 | [Subscriptions](./19-subscriptions.md) | ✅ Accepted; Phase 1 (Foundations) and Phase 2 (Trial Engine) implemented & closed (see `19-milestone-review-phases-1-2.md`); POL-19-010 (Payment Reversal), POL-19-011 (V1 Commercial Plan & Processor Decision), and POL-19-013 (Payment Reversal Amendment — simplified grace-period rule) recorded; V1 payment-path Rule 8 Assessment v2 complete (`19-v1-payment-path-rule8-assessment-v2.md`); Phase 3/Phase 5 minimum-slice implementation not yet authorized |
