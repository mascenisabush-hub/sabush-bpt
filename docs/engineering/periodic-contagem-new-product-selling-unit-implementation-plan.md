...
**No new BDR or Policy is required.** If, on review, the Product Architect judges that B.2's explicit scope exclusion should not be reopened via ordinary engineering discretion, that is the one point in this Plan worth an explicit sign-off on specifically — flagged here rather than assumed.
