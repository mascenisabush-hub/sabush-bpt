          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-white border border-[#E5E7EB] rounded-[9px] px-3.5 py-2.5 text-[#111827] text-sm transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12]"
              >
                {products.map(p => (
            ...
            <div>
              ...
              {availableBatches.length === 0 ? (
                ...
                <select
                  ...
                  className="w-full bg-white border border-[#E5E7EB] rounded-[9px] px-3.5 py-2.5 text-[#111827] text-sm transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12] font-mono"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E5E7EB] rounded-[9px] px-3.5 py-2.5 text-[#111827] text-sm font-mono tabular-nums transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12]"
                />
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-[#E5E7EB] rounded-[9px] px-3.5 py-2.5 text-[#111827] text-sm placeholder-gray-400 transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12] mb-2.5"
              />
              ...
              <div className="flex flex-wrap gap-2 items-center">
                ...
                {COMMON_REASON_KEYS.map(key => (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-[var(--muted)] hover:bg-[#2563EB]/[0.08] hover:text-[#0B1F3A] text-gray-600 text-xs font-semibold border border-[#E5E7EB] hover:border-[#2563EB]/40 transition-all duration-150 active:scale-95"
                  >
                    {t(key)}
                  </button>
                ))}
