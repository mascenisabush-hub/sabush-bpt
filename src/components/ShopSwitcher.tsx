  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-[#B8791A] mb-0.5 hover:text-[#9C6613] transition-colors"
      >
        Meu Negócio
              ...
              <div className="max-h-64 overflow-y-auto py-1">
                {ownedBusinesses.map((b) => (
                  ...
                  >
                    ...
                    {b.id === activeBusinessId && <Check className="w-4 h-4 text-[#B8791A] shrink-0" />}
                  </button>
                ))}
              </div>
