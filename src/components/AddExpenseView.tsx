          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-[#E5E7EB] rounded-[10px] px-4 py-2.5 text-[#111827] text-sm placeholder-gray-400 transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12]"
              />
            </div>
