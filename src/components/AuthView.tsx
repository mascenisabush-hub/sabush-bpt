    ...
    <div className="min-h-screen relative flex flex-col justify-center items-center p-4 sm:p-6 font-sans overflow-hidden bg-[#00020F] text-white">
      ...
      <style>{`
        ...
        .av-orb-2 {
          ...
          background: radial-gradient(circle, rgba(11,31,58,0.32), transparent 65%);
          animation: av-drift-2 19s ease-in-out infinite alternate;
        }
        .av-orb-3 {
          width: 420px; height: 420px; top: 12%; right: 4%;
          background: radial-gradient(circle, rgba(255,140,66,0.24), transparent 65%);
        ...
        .av-card {
          ...
          box-shadow: 0 25px 70px -12px rgba(0,0,0,0.6), 0 0 90px -20px rgba(232,198,92,0.35);
        }
