          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E5E7EB] rounded-[10px] px-4 py-2.5 text-[#111827] text-sm transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12] font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E5E7EB] rounded-[10px] px-4 py-2.5 text-[#111827] text-sm transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12] font-mono tabular-nums"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-[#E5E7EB] rounded-[10px] px-4 py-2.5 text-[#111827] text-sm placeholder-gray-400 transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12] mb-2.5"
              />
                ...
                {COMMON_REASON_KEYS.map(key => {
                  ...
                  return (
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-[#FAFBFC] hover:bg-[#2563EB]/[0.08] text-gray-600 hover:text-[#0B1F3A] text-xs font-semibold transition-all duration-150 border border-[#E5E7EB] hover:border-[#2563EB]/30 active:scale-95"
                    >
                      {label}
                    </button>
                  );
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white border border-[#E5E7EB] rounded-[10px] px-4 py-2.5 text-[#111827] text-sm placeholder-gray-400 transition-all duration-150 focus:outline-none focus:border-[#2563EB] focus:ring-4 focus:ring-[#2563EB]/[0.12] resize-none"
              />
            </div>
