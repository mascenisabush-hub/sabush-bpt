...
export const en: TranslationDict = {
  ...
  header: {
    ...
    avatarUploadError: 'Could not upload the photo. Please try again.',
    settings: 'Settings',
    currency: 'Currency',
  ...
  addStock: {
    ...
    removeRowConfirm: 'Remove this row? The data already entered (product, quantity, prices) will be lost.',
    ...
    smartEntry: {
      ...
      openInChrome: 'Open in Chrome (recommended)',
      openInSafariInstructions: 'At the top of the screen, tap "\u22ef" and choose "Open in Safari".',
      fields: {
        product: 'Product',
        quantity: 'Quantity',
        unit: 'Unit',
    ...
    supplierWording: {
      ...
      grounds: {
        initialStockName: 'Same name as in your catalog',
        existingAlternativeWording: 'Already linked to this product',
        unitSpellingEquivalence: 'Same quantity, unit spelled differently',
        characterSpellingVariation: 'Spelling is similar',
        abbreviationMatch: 'Known short form',
        synonymMatch: 'Known alternate name',
        translationMatch: 'Known translation',
        semanticMatch: 'Smart suggestion',
      },
      contradictionNotShownNotice: 'Not shown: quantities/sizes appear to differ.',
    },
    sequencing: {
  ...
  productCatalog: {
    ...
    form: {
      ...
      nameRequiredError: 'Please enter the product name.',
      sellingPriceRequiredError: 'Please enter a valid selling price.',
      sellingPriceInvalidError: 'Please enter a valid selling price.',
      unitRelationshipLabel: 'Unit Relationship (optional)',
      unitTopLevelPlaceholder: 'E.g. Box',
      unitLevelPlaceholder: 'E.g. Unit',
      addUnitLevelButton: 'Add level',
      unitFactorInvalidError: 'Enter a valid conversion factor (greater than zero) for each level.',
      sellingUnitLabel: 'Selling Unit',
      sellingUnitPlaceholder: 'Select the selling unit',
      sellingUnitRequiredError: 'Setting a selling price requires a valid selling unit.',
      submitButton: 'Register',
      cancelButton: 'Cancel',
      similarProductsFound: 'We found similar products in your catalog. Confirm whether this is one of them, or a genuinely new product.',
      useExistingButton: 'Use this existing product',
      confirmNewButton: 'Confirm as new product',
      existingResolvedMessage: 'Product already exists in the catalog — no new product was created.',
      successMessage: 'Product registered in the catalog successfully.',
      genericError: 'Could not register the product. Please try again.',
    },
  },
  stocksView: {
  ...
  reports: {
    ...
    kpiBusinessWorthEstimated: 'Business Worth (Estimated)',
    kpiCapitalGrowth: 'Capital Growth',
    heroLabel: 'Current Business Worth',
    heroLabelEstimated: 'Business Worth (Estimated)',
    ...
    capitalGrowth: {
      ...
      kpiInitialCapital: 'Initial Capital',
      kpiCurrentCapital: 'Current Business Worth',
      kpiCurrentCapitalFull: 'Current Business Worth',
      kpiCurrentCapitalEstimated: 'Business Worth (Estimated)',
      kpiCurrentCapitalFullEstimated: 'Business Worth (Estimated)',
