...
export const fr: TranslationDict = {
  ...
  addStock: {
    ...
    newProductSellingUnitSameAsCostUnitWarning:
      'L\u2019unité de vente ne peut pas être identique à l\u2019unité d\u2019achat (« {{unit}} ») ci-dessus — vérifiez que l\u2019unité d\u2019achat est correcte, ou choisissez une unité de vente différente. Sans cette distinction, la relation d\u2019unités ne peut pas être enregistrée.',
    ...
    correction: {
      editButton: 'Corriger les détails du produit',
      nameChangeConfirmTitle: 'Confirmer le changement de nom',
      nameChangeConfirmBody:
        'Voulez-vous vraiment renommer « {{old}} » en « {{new}} » ? Cette modification affecte le produit dans tous les enregistrements futurs.',
      sellingUnitRequiredError: 'Une unité de vente valide est requise pour définir un prix de vente.',
  ...
  productCatalog: {
    ...
    form: {
      ...
      nameRequiredError: 'Veuillez saisir le nom du produit.',
      sellingPriceRequiredError: 'Veuillez saisir un prix de vente valide.',
      sellingPriceInvalidError: 'Veuillez saisir un prix de vente valide.',
      unitRelationshipLabel: 'Relation d\\u2019Unités (optionnel)',
      unitTopLevelPlaceholder: 'Ex : Caisse',
      unitLevelPlaceholder: 'Ex : Unité',
      addUnitLevelButton: 'Ajouter un niveau',
      unitFactorInvalidError: 'Saisissez un facteur de conversion valide (supérieur à zéro) pour chaque niveau.',
      sellingUnitLabel: 'Unité de Vente',
      sellingUnitPlaceholder: 'Sélectionnez l\\u2019unité de vente',
      sellingUnitRequiredError: 'Définir un prix de vente nécessite une unité de vente valide.',
      submitButton: 'Enregistrer',
      cancelButton: 'Annuler',
      similarProductsFound: 'Nous avons trouve des produits similaires dans votre catalogue. Confirmez s\\u2019il s\\u2019agit de l\\u2019un d\\u2019eux, ou d\\u2019un produit reellement nouveau.',
      useExistingButton: 'Utiliser ce produit existant',
      confirmNewButton: 'Confirmer comme nouveau produit',
      existingResolvedMessage: 'Produit deja existant dans le catalogue — aucun nouveau produit n\\u2019a ete cree.',
      successMessage: 'Produit enregistre dans le catalogue avec succes.',
      genericError: 'Impossible d\\u2019enregistrer le produit. Veuillez reessayer.',
    },
  },
  stocksView: {
